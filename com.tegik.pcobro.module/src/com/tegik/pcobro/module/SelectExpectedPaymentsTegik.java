...
import com.tegik.pcobro.module.FIN_AddPaymentTegik;
...
public class SelectExpectedPaymentsTegik extends HttpSecureAppServlet {
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/tegik/pcobro/module/SelectExpectedPaymentsTegik", discard)
        .createXmlDocument();
  ...
  private void printGrid(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/tegik/pcobro/module/AddPaymentProposalGridTegik").createXmlDocument();
    ...
    if (strSelectedPaymentDetails == null || "".equals(strSelectedPaymentDetails))
      firstLoad = true;
    if (firstLoad)
      selectedScheduledPaymentDetails = FIN_AddPaymentTegik
          .getSelectedPendingPaymentsFromProposal(paymentProposal);
    else
      selectedScheduledPaymentDetails = FIN_AddPaymentTegik.getSelectedPaymentDetails(null,
    ...
    final FieldProvider[] data = FIN_AddPaymentTegik.getShownScheduledPaymentDetails(vars,
  ...
  private void saveAndClose(HttpServletResponse response, VariablesSecureApp vars,
    ...
    try {
      ...
      if (!"".equals(strSelectedScheduledPaymentDetailIds)) {
        ...
        HashMap<String, BigDecimal> selectedPaymentScheduleDetailAmounts = FIN_AddPaymentTegik
        ...
        FIN_AddPaymentTegik.savePaymentProposal(paymentProposal, newPaymentAmount,
