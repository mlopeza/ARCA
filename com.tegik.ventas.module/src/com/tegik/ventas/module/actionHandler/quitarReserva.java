 ...
 * 
 */
public class quitarReserva extends BaseProcessActionHandler {
 
  private static final Logger log = Logger.getLogger(quitarReserva.class);
  ...
  private HashMap<String, String> reservarPiezas(JSONObject jsonRequest, ventaspickexecute pickObject) throws JSONException, OBException {
    ...
    for (int i = 0; i < selectedLines.length(); i++) {
	    ...
	    {
		  asiObject.setAlmacReservacotizacion(false);
		  asiObject.setAlmacReservapedido(false);
	    }
  
	    asiObject.setVentasPickexecute(null);
